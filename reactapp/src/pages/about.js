...
import MultipleItem from "../assets/MultipleItems.jpeg";
...
function About() {
  return (
    <div className="about">
      <div
        className="aboutTop"
        style={{ backgroundImage: `url(${MultipleItem})` }}
      ></div>
      <div className="aboutBottom">
        <h1> ABOUT US</h1>
        <p>
        Bangalore at S Mart online grocery store. Best price on fresh fruits & vegetables, dairy & bakery, packaged food.
